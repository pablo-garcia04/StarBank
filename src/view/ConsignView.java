 ...
 * @author samue
 */
public class ConsignView extends javax.swing.JFrame {

    private final Validator validator;
    private final Cashier cashier;

    /**
     * Creates new form ConsignView
     */
    public ConsignView(Cashier cashier) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Valor consignacion:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(consignBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void consignBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consignBtnActionPerformed
        int err = validator.validateConsignView(id.getText(), errorID, value.getText(), errorValue);
        if (err != 0) {
            return;
        }
        float valueF = Float.parseFloat(value.getText());
        cashier.getOperator().updateBalanceAccount(id.getText(), valueF,true,cashier.idBranchOffice);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsignView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsignView().setVisible(true);
            }
        });
    }
